...
namespace SMTPTest
{
    ...
    static class ArgsSMTPAPI
    {
        public static string GetSubject(this string text, string stopAt = "--message", string startAt = "--subject")
        {
            ...
            return String.Empty;
            // SMTPTest.exe --loginusername yourcoolusername@domain.com --address smtp.myserver.com --smtppass myCoolpassword --port 587 --ssl true --subject Hey,how are you doing ? --message Hey,adsadsa asd adsa how are you ? --receiver admin@gmail.com --end
        }
